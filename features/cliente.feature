...
Scenario: Cadastrar novo cliente
  Given existe um usuario cadastrado com o nome 'Fulano da Silva', CPF '91352091437', funcao 'Gesseiro' e senha 'password'
  ...
  When eu preencho os campos com nome 'Nome de Teste', cpf '37968977460', contato '952136988', cidade 'Garanhuns', bairro 'Boa Vista', logradouro 'Rua da Doze' e complemento 'Numero 123'
...
Scenario: Cadastrar Novo Cliente com cpf ja cadastrado
  ...
  And estou logado no sistema com o login '91352091437' e senha 'password'
  When eu entro na pagina clientes
  And existe um cliente com nome 'Cliente Teste I', cpf '37968977460', contato '996439788', cidade 'Garanhuns', bairro 'Boa Vista', logradouro 'Rua da Doze' e complemento 'Numero 123'
  And clico em novo cliente
  When eu preencho os campos com nome 'Cliente Teste II', cpf '37968977460', contato '992156988', cidade 'São paulo', bairro 'mooca', logradouro 'Rua nova são paulo' e complemento 'Numero 1580'
  And eu clico em cadastrar cliente
...
Scenario: Editar cliente
  ...
  When eu entro na pagina clientes
  And existe um cliente com nome 'Cliente Teste I', cpf '37968977460', contato '996439788', cidade 'Garanhuns', bairro 'Boa Vista', logradouro 'Rua da Doze' e complemento 'Numero 123'
  When clico em editar cliente com o nome 'Cliente Teste I'
  And edito os dados com nome 'Cliente da Silva', cpf '37968977460', contato '99999999', cidade 'Recife', bairro 'Ibura', logradouro 'rua da idependencia' e complemento 'Numero 100'
...
Scenario: Apagar cliente
  ...
  And estou logado no sistema com o login '91352091437' e senha 'password'
  When eu entro na pagina clientes
  And existe um cliente com nome 'Cliente Teste', cpf '37968977460', contato '996439788', cidade 'Garanhuns', bairro 'Boa Vista', logradouro 'Rua da Doze' e complemento 'Numero 123'
