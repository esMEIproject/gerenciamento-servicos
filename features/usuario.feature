...
Scenario: Cadastrar novo usuario com campo cpf ja existente
  Given eu estou na pagina de login
  And existe um usuario com o nome 'usuario001', cpf '91352091437', funcao 'Gesseiro' e senha 'password'
  When eu clico para cadastrar um novo usuario
  And eu preencho os campos de nome 'usuario002', cpf '91352091437', funcao 'Gesseiro' e senha 'password'
...
Scenario: Editar Usuario com campo cpf vazio
  Given eu estou na pagina de login
  And existe um usuario com o nome 'Usuario Admin', cpf '91352091437', funcao-cargo 'Gesseiro' e senha 'password'
