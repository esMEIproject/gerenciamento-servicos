...
class ServicosTest < ApplicationSystemTestCase
  ...
  test "creating a Servico" do
    ...
    check "Statusdepagamento" if @servico.statusDePagamento
    fill_in "Tipodoservico", with: @servico.tipoDoServico
    fill_in "Valordoservico", with: @servico.valorDoServico
